...
def weather_home():
    try:
        ...
        return render_template("error.html", error="Unable to fetch weather data. Please try again later.")
...
def weather_homeXML():
    try:
        ...
        return render_template("error.html", error="There was a problem processing the weather data. Please try again later.")
